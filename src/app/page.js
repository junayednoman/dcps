          ...
          <div className="text-center">
            <div className="flex justify-center items-center gap-6 mb-5">
              <a href="https://www.dpe.gov.bd/" target="_blank">
                <Image width={80} height={80} src={psLogo} alt="primary education logo" className="mb-5"></Image>
              </a>
              <a href="https://bangladesh.gov.bd/" target="_blank">
                <Image width={80} height={80} src={govLogo} alt="Bd GOV logo" className="mb-5"></Image>
              </a>
            </div>

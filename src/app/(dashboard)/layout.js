        ...
        <main className={notoBengali.className}>
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open}>
                    ...
                    <h1 className=' font-bold text-[25px] absolute top-3 left-7 text-[#008B4C]'><a href="https://www.dpe.gov.bd/" target='_blank'><Image src={logo} alt='logo' width={70} height={70}></Image></a></h1>

                                    ...
                                    <Box sx={{ width: '100%' }}>
                                        ...
                                        <CustomTabPanel value={schoolTabValue} index={2}>
                                            ...
                                            <div className='pt-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full gap-x-4'>
                                                ...
                                                <NumberField name="khatian_number" label="খতিয়ান নং" placeholder="খতিয়ান নং দিন" />
                                                                        ...
                                                                        {values.nursery_five_plus.map((nursery_five_plus, index) => (
                                                                            <div key={index}>
                                                                                <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full gap-x-4'>
                                                                                    ...
                                                                                    <NumberField name={`nursery_five_plus.${index}.muslim_total_student`} label="মোট মুসলিম শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
                                                                                    ...
                                                                                    <NumberField name={`nursery_five_plus.${index}.hindu_total_student`} label="মোট হিন্দু শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
                                                                                    ...
                                                                                    <NumberField name={`nursery_five_plus.${index}.total_student`} label="মোট শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
                                                                        ...
                                                                        {values.class_one.map((class_one, index) => (
                                                                            <div key={index}>
                                                                                <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full gap-x-4'>
                                                                                    ...
                                                                                    <NumberField name={`class_one.${index}.muslim_total_student`} label="মোট মুসলিম শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
                                                                                    ...
                                                                                    <NumberField name={`class_one.${index}.hindu_total_student`} label="মোট হিন্দু শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
                                                                                    ...
                                                                                    <NumberField name={`class_one.${index}.total_student`} label="মোট শিক্ষার্থী" placeholder='মোট সংখ্যা দিন' />
